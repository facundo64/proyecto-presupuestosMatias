            ...
            <style>{`
                @media print { 
                    ...
                    #print-area { 
                        ...
                        top: 0; 
                        width: 100%;
                        font-size: 11px; /* Tamaño de fuente reducido para impresión */
                        padding: 2rem !important; /* Asegura un margen adecuado en el papel */
                    } 
                            ...
                            {item.isPackage ? (
                                ...
                                <>
                                    ...
                                    {item.subItems.map((sub, subIndex) => (
                                        <div key={subIndex} className="grid grid-cols-12 gap-4 items-start pt-2">
                                            <div className="col-span-3"></div>
                                            <div className="col-span-7"><p className="text-gray-700">{sub.description}</p></div>
                                    ...
                                    <div className="grid grid-cols-12 gap-4 items-start py-4">
                                        <div className="col-span-3"></div>
                                        <div className="col-span-7 pt-2 border-t"><p className="font-semibold text-gray-800">{item.laborType}</p></div>
                                ...
                                <div className="grid grid-cols-12 gap-4 items-start py-4">
                                    ...
                                    <div className="col-span-7">
                                        ...
                                        <div className="pt-2 mt-2 border-t">
                                            <p className="font-semibold text-gray-800">{item.laborType}</p>
                                        </div>
                                    </div>
                                    <div className="col-span-2 text-right font-bold text-gray-800">
                                        <div className="h-full flex flex-col justify-end">
                                             <div className="pt-2 mt-2 border-t border-transparent whitespace-nowrap">
                ...
                <div className="flex justify-end mt-8">
                    <div className="w-full max-w-md">
                        <div className="flex justify-between items-center font-bold text-lg text-gray-800 bg-gray-100 p-4 rounded-lg">
                            <span className="whitespace-nowrap">TOTAL A PAGAR ({quote.currency}):</span>
                            <span className="whitespace-nowrap">{formatPrice(quote.total, quote.currency)}</span>
                        </div>
                    </div>
                </div>
